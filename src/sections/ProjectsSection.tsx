const ProjectsSection = () => {
  return (
    <section id="projects" className="py-16 bg-black text-white text-center" data-aos="fade-up" data-aos-duration="800">
      ...
      <div className="flex justify-center space-x-8">
        ...
        <div className="w-64 bg-gray-800 p-4 rounded-lg">
          <img src="/ocoffee.png?v=1" alt="Project Name" className="w-full h-40 object-cover rounded-md mb-4" />
